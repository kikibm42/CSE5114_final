...
def main():
    ...
    <div class="header-bar">
        <div>
            ...
            <div class="header-sub">Powered by Snowflake · Spark Streaming · Kafka</div>
        </div>
    ...
    if games_df.empty:
        st.info("No game data found in LIVE_DATA. Make sure the Kafka producer and Spark consumer are running.")
    else:
